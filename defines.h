...
#if ENABLE_WIFI && defined(ESP32)
#define WIFI_ESP32_ON true

#elif ENABLE_WIFI && (defined(ARDUINO_AVR_MEGA) || defined(ARDUINO_AVR_MEGA2560) || defined(ARDUINO_SAMD_ZERO)  || defined(TEENSYDUINO))
#define WIFI_ON true
#ifndef WIFI_CHANNEL
